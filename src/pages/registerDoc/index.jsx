...
export const RegisterDoc = () => {
    ...
    const handleSubmit = async(e) => {
        ...
        if ( matricula.length < 0 || matricula.length > 12 || matricula <= 0 ){
            Swal.fire({
                icon: 'error',
                title: 'MATRICULA: datos incorrectos!',
                text: 'La matricula debe tener como máximo 12 numeros.',
              })
              return
        }
        if (Number.isNaN(Number(matricula))) {
            Swal.fire({
                icon: 'error',
                title: 'MATRICULA: datos incorrectos!',
                text: 'La matricula sólo debe contener datos numéricos.',
              })
        }
        ...
        <div className="wrapper3">
            <div className="form-wrapper">
                <form onSubmit={handleSubmit}>
                    <h2>Registrarse como Doctor</h2>
                    <div className="input-group">
                        <input type="text" value={nombre} maxLength={30} onChange={(e) => setNombre(e.target.value)} required/>
                        <label>Nombre</label>
                    </div>
                    <div className="input-group">
                    ...
                    <div className="input-group">
                        <input
                            ...
                            className={`date-input ${isFocusedDate ? 'active' : ''}`}
                    ...
                    <div className="input-group">
                        <input type={showPassword1 ? "text" : "password"} value={password} maxLength={20} onChange={(e) => setPassword(e.target.value)} required/>
