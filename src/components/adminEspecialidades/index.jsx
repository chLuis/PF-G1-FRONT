...
export const AdminEspecialidades = () => {
    ...
    return (
        <>
            <>
                                        <h4 className="h4-add-especialidades h4-agregar-Especialidad">Agregar especialidades</h4>
                                        ...
                                        {especialidades?.map((especialidad, i) =>
                                            ...
                                            <div className="div-update-img-especialidades">
                                                ...
                                                <div className="btn-div-update-img">
                                                    <button className="btn-approve-admin" onClick={updateImageEsp}>Aceptar</button>
